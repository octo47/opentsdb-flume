...
final class LineBasedFrameDecoder extends FrameDecoder {
  ...
  private final static Map<String, String> NONE = new HashMap<String, String>();
  ...
  public final static class LineEvent implements Event {

    private Map<String, String> headers = NONE;
    private byte[] body;

    public LineEvent(byte[] body) {
      this.body = body;
    }
